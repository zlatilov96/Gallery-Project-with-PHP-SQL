				  ...
				  <div class="w3-half w3-container">
				    ...
				    <!-- FORM -->
				    	...
				    	<form action="publish_photo.php" method="post" enctype="multipart/form-data" class="w3-container form-bg">
						  ...
						  <input class="w3-input w3-border w3-round" type="text" name="photo_title"></p>
						  <p>
						  <label><strong>Description</strong></label>
						  <textarea class="w3-input w3-border w3-round" cols="20" rows="7" name="photo_desc"></textarea></p>
						  <p>
						  <label><strong>Keywords</strong></label>
						  <input class="w3-input w3-border w3-round" type="text" name="photo_keywords"></p>
						  <p>
						  <label><strong>Image</strong></label>
						  <input class="w3-input w3-border w3-round" type="file" name="photo_image"></p>
						  <p class="w3-center">
